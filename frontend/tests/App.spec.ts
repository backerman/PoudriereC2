...
test.beforeEach(async ({ page }) => {
  await page.route('https://login.microsoftonline.com/common/discovery/**/*', async route => {
    const response = {
  ...
  await page.route('https://login.microsoftonline.com/**/openid-configuration', async route => {
    const response = {
  ...
  await page.route('https://login.microsoftonline.com/**/token', async route => {
    const response = {
      "token_type": "Bearer",
...
test('renders nav bar', async ({ page }) => {
  ...
  const topBarText = page.getByText('Poudriere build management');
